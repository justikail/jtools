...
function CSR() {
  ...
  useEffect(() => {
    const isValid = state.saldo.trim() !== "" && state.norek.trim() !== "";
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch("/api/fakebca", {
      method: "POST",
      headers: {
  ...
  const handleDownload = () => {
    ...
    link.href = result;
    link.download = `fake_saldo_bca.png`;
  ...
  return (
    <CardTools title="Fake Saldo BCA Generator" description="Tools untuk generate fake screenshot MyBCA dengan custom nomor rekening dan nominal saldo.">
