...
function CSR() {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch("/api/fakebni", {
      method: "POST",
      headers: {
  ...
  const handleDownload = () => {
    ...
    link.href = result;
    link.download = `fake_saldo_bni.png`;
  ...
  return (
    <CardTools title="Fake Saldo BNI Generator" description="Tools untuk generate fake screenshot BNI dengan custom No. Rekening, dan nominal saldo.">
